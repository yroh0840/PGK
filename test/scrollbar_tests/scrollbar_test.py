...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.canvas = tk.Canvas(self, width=540, height=3000, bg="white")
        ...
        canvas.config(scrollregion=(1,2,1,50)) #スクロール範囲
        #マウスのホイールの動きに対応させる
        canvas.bind_all("<MouseWheel>", lambda eve:canvas.yview_scroll(int(-eve.delta/60), 'units'))
        self.canvas.pack()
